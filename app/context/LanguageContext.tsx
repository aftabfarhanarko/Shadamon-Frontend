...
const translations: Record<string, Record<Language, string>> = {
    ...
    'promote': { bn: 'প্রচার করুন', en: 'Promote' },
    ...
    'about_us': { bn: 'আমাদের সম্পর্কে', en: 'About Us' },
    'terms_and_con': { bn: 'শর্তাবলী', en: 'Term & Con.' },
    'privacy_policy': { bn: 'প্রাইভেসি পলিসি', en: 'Privacy Policy' },
    'contact_us': { bn: 'যোগাযোগ', en: 'Contact Us' },
    ...
    'add_photos_btn': { bn: 'ছবি যোগ করুন', en: 'Add Photos' },
    'drag_and_drop': { bn: 'অথবা এখানে ড্র্যাগ এন্ড ড্রপ করুন', en: 'or drag and drop' },
    ...
    'free_ad_limit_reached_desc': { bn: 'পোস্টটি তৈরি হয়েছে, কিন্তু প্রকাশ হয়নি কারণ, ফ্রি পোস্ট সীমা শেষ। এখনই প্রকাশ করে অসংখ্য কাস্টমারের কাছে পৌঁছাতে - প্রমোট করুন!', en: 'The post has been created but not published because the free post limit has been reached. Promote it now to publish and reach countless customers!' },
